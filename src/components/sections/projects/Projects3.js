"use client";
import projectImage8 from "@/assets/img/project/stkitts.jpg";
import projectImage9 from "@/assets/img/project/dubai.jpg";
import projectImage10 from "@/assets/img/project/malta.jpg";
          ...
          <div className="col-xl-9 col-lg-9 col-md-9 col-sm-8 col-8">
            <div className="section__title section__title--2  section__title--3">
              <div className="section__title__button">
                <span>Our Top Programs</span>
              </div>
              <div className="section__title__heading">
                <h3>OUR MOST SORT AFTER SERVICES</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="project__3__button">
              <ButtonPrimary text="VIEW OTHER PROGRAMS" path="/ohservices" />
            </div>
          </div>
        </div>
      </div>
