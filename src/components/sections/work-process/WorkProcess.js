  ...
  const items = [
    {
      ...
      desc: "Personalized advisory session to understand your needs and recommend the best solutions.",
      duration: 1500,
      path: "/services",
    ...
    },
    {
      ...
      desc: "Guidance through the application process, ensuring efficiency and confidentiality every step of the way.",
      duration: 2100,
      path: "/projects",
    ...
    },
    {
      ...
      desc: "Finalize your citizenship or residency with ongoing support and peace of mind.",
      duration: 2700,
      path: "/projects",
